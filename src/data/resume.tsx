...
export const DATA = {
  ...
  summary:
    "I'm a software engineer who enjoys turning ambiguous ideas into products that people rely on every day. Over the last year, I've worked closely with founders and (super)fast moving startups, shipping production grade features across CRM systems, internal tools, proctored examination platform, GIS applications, dashboards and AI integrated products. I care deeply about building intuitive user experiences, moving quickly without compromising quality, and solving real problems for real users. As AI reshapes how software is built and used, I'm excited to contribute to teams working on products with the potential to impact millions!",
  avatarUrl: "/me.jpg",
  skills: [
    "React",
    "Next.js",
  ...
  work: [
    {
      ...
      description:
        "Engineered a CRM platform with React and Django that improved workflow efficiency for a 20+ member team. Developed WCAG-compliant features to deliver an accessible experience for screen reader users. Implemented a real-time task tracking system using WebSockets, enabling team members to efficiently manage and monitor their daily tasks. Created an end-to-end client dashboard, providing visibility into every stage of the customer journey, from order placement to delivery.",
    },
    {
      company: "SkillDzire",
      ...
      description:
        "Worked closely with the founder to improve an online proctored examination system built on ExamPro and the Frappe framework. Expanded the platform's functionality by introducing automated proctoring reports and noise detection for more effective invigilation. Developed an auxiliary device tracking solution that utilized a secondary mobile camera feed to identify potential malpractice from angles not covered by the primary webcam. Leveraged YOLOv8 library for object detection to flag unauthorized items such as notes, books, and mobile phones during examinations.",
    },
    {
      company: "EzyHelpers",
      ...
      description:
        "Delivered production ready features through CI/CD pipelines in a fast-moving environment, quickly adapting to changing requirements and stakeholder feedback. Using Django, developed CRM dashboards, lead funnels, performance tracking tools, and REST APIs for mobile devices,  supporting a 25-member operations team. Contributed to code reviews across payment, authentication, communication services, and improved the platform through regular UI/UX enhancements and bug fixes.",
    },
    {
